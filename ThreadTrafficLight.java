...
public class ThreadTrafficLight extends JFrame implements ActionListener
{
    ...
    JLabel red = new JLabel("STOP");
    JLabel yellow = new JLabel("READY");
    JLabel green = new JLabel("GO");
	...
	public static void main(String args[]) {
		ThreadTrafficLight PFrame = new ThreadTrafficLight();
